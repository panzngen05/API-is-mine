    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api PanzNgen - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6283185414829">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>PanzNgen</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"PanzNgen" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api PanzNgen`,
        html: inboxGmail,
      };
